"""A hello-world filter plugin in sshedmake_namespace_12.myrhdh_12."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_12 Myrhdh_12
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_12.myrhdh_12.hello_world }}"
"""
